        ...
        public static Object RecorrerArbol(ParseTreeNode Nodo)
        {
            switch (Nodo.Term.Name)
            {
                ...
                case Constante.FUNCION:
                    {
                        if (Nodo.ChildNodes[1].Term.Name.Equals(Constante.TMetodo) || Nodo.ChildNodes[2].Term.Name.Equals(Constante.TMetodo))
                        {
                            ...
                            else
                            {
                                ...
                                FMetodo metodo = new FMetodo(visibilidad, Constante.TVoid, id, parametros, new Ambito(id, cuerpo), Nodo.ChildNodes[3].Token.Location.Line + 1, Nodo.ChildNodes[3].Token.Location.Column + 1);
                        ...
                        else if (Nodo.ChildNodes[1].Term.Name.Equals(Constante.TFuncion) || Nodo.ChildNodes[2].Term.Name.Equals(Constante.TFuncion))
                        {
                            ...
                            else
                            {
                                ...
                                FMetodo metodo = new FMetodo(visibilidad, tipo, dimensiones, id, parametros, new Ambito(id, cuerpo), Nodo.ChildNodes[5].Token.Location.Line + 1, Nodo.ChildNodes[5].Token.Location.Column + 1);
                ...
                case Constante.ELEGIR:
                    {
                        ...
                        elegir.Ambito.Tamaño = 0;
                        foreach (FCaso cas in casos)
                        {
                            cas.Padre = sim;
                            cas.Valor.SetPadre(sim);
                            foreach (Simbolo sm in cas.Ambito.TablaSimbolo)
                            {
                                sm.Padre = sim;
                                elegir.Ambito.Tamaño += sm.Tamaño;
                            }
                        }
                        ...
                        sim.Tamaño = elegir.Ambito.Tamaño;
                ...
                case Constante.TSelf:
                    ...
                    return new FNodoExpresion(null, null, Constante.LLAMADA_OBJETO, Constante.LLAMADA_OBJETO, Nodo.Token.Location.Line + 1, Nodo.Token.Location.Column + 1, "");
